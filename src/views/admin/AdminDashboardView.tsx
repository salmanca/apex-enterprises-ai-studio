            ...
            <div className="flex items-center gap-3 text-xs">
              ...
              >
                ...
                <span className="truncate max-w-[200px]">
                  <strong className="text-white">{user?.name || user?.email || 'apexenterprises'}</strong>
                </span>
                {user?.role && (
                    ...
                    <button
                      onClick={() => {
                        setEditingStore({
                          ...
                          latitude: 12.978974253433234,
                          longitude: 77.63321298380423,
                          googleMapsUrl: 'https://maps.app.goo.gl/zFuFPoEyujNMb8Ua8',
                          imageUrl: 'https://lh3.googleusercontent.com/gps-cs-s/AHRPTWmTqAcz2IdASLsCVUD45VBSfZeoKpCajBxFzYazeyIdxC3u1uFo7Bz5mPkz5c-dvPkR5tTwvFi-KxuNSs1EytPnAcEyZJAEKP_u77yY8ORYd8LvRtzXpd2c4E0fs_qh8Qf4s53h=w426-h240-k-no',
                          isActive: true,
                          createdAt: new Date().toISOString(),
                          updatedAt: new Date().toISOString()
                        });
